...
namespace river\Console\Commands;

use Closure;
use Illuminate\Console\Command;
use river\Console\Kernel;
use Symfony\Component\Process\Process;
use Symfony\Component\Console\Helper\ProgressBar;

class UpgradeCommand extends Command
{
    protected const DEFAULT_URL = 'https://github.com/river/panel/releases/%s/panel.tar.gz';
    ...
    protected $signature = 'p:upgrade
        ...
        {--release= : A specific river version to download from GitHub. Leave blank to use latest.}
        {--skip-download : If set no archive will be downloaded.}';

    /** @var string */
    protected $description = 'Downloads a new archive for river from GitHub and then executes the normal upgrade commands.';

    /**
     * Executes an upgrade command which will run through all of our standard
     * commands for river and enable users to basically just download
    ...
    public function handle()
    {
        ...
        /** @var \river\Console\Kernel $kernel */
        ...
        $this->newLine(2);
        $this->info('Panel has been successfully upgraded. Please ensure you also update any Wings instances: https://river.io/wings/1.0/upgrading.html');
    }
