...
use river\Services\Eggs\EggConfigurationService;
use river\Repositories\Eloquent\ServerRepository;
use river\Http\Resources\Wings\ServerConfigurationCollection;
...
class ServerDetailsController extends Controller
{
    ...
    /**
     * @var \river\Services\Eggs\EggConfigurationService
     */
     ...
     *
     * @return \river\Http\Resources\Wings\ServerConfigurationCollection
     */
    ...
    public function resetState(Request $request)
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \river\Models\ActivityLog|null $activity */
