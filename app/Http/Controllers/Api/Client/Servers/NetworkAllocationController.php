...
use river\Transformers\Api\Client\AllocationTransformer;
use river\Http\Controllers\Api\Client\ClientApiController;
use river\Services\Allocations\FindAssignableAllocationService;
use river\Http\Requests\Api\Client\Servers\Network\GetNetworkRequest;
use river\Http\Requests\Api\Client\Servers\Network\NewAllocationRequest;
use river\Http\Requests\Api\Client\Servers\Network\DeleteAllocationRequest;
use river\Http\Requests\Api\Client\Servers\Network\UpdateAllocationRequest;
use river\Http\Requests\Api\Client\Servers\Network\SetPrimaryAllocationRequest;
...
class NetworkAllocationController extends ClientApiController
{
    ...
    /**
     * @var \river\Services\Allocations\FindAssignableAllocationService
     */
