...
use river\Helpers\Utilities;
use river\Exceptions\DisplayException;
use river\Repositories\Eloquent\ScheduleRepository;
use river\Services\Schedules\ProcessScheduleService;
use river\Transformers\Api\Client\ScheduleTransformer;
use river\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use river\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use river\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use river\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use river\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use river\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;

class ScheduleController extends ClientApiController
{
    /**
     * @var \river\Repositories\Eloquent\ScheduleRepository
     */
    private $repository;

    /**
     * @var \river\Services\Schedules\ProcessScheduleService
     */
    private $service;
    ...
    {
        /** @var \river\Models\Schedule $model */
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule)
    {
        ...
        //
        // @see https://github.com/river/panel/issues/2425
