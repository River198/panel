...
namespace river\Http\Middleware;

use Closure;
use Illuminate\Support\Str;
use Illuminate\Http\Request;
use Prologue\Alerts\AlertsMessageBag;
use river\Exceptions\Http\TwoFactorAuthRequiredException;
...
class RequireTwoFactorAuthentication
{
     ...
     * @return mixed
     *
     * @throws \river\Exceptions\Http\TwoFactorAuthRequiredException
     */
    public function handle(Request $request, Closure $next)
    {
        ...
        $level = (int) config('river.auth.2fa_required');
