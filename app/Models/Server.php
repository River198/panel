...
namespace river\Models;

use Illuminate\Notifications\Notifiable;
use Illuminate\Database\Query\JoinClause;
use Znck\Eloquent\Traits\BelongsToThrough;
use Illuminate\Database\Eloquent\Relations\MorphToMany;
use river\Exceptions\Http\Server\ServerStateConflictException;
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property \river\Models\Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\Database[] $databases
 * @property int|null $databases_count
 * @property \river\Models\Egg|null $egg
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\Mount[] $mounts
 * @property int|null $mounts_count
 * @property \river\Models\Nest $nest
 * @property \river\Models\Node $node
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\Subuser[] $subusers
 * @property int|null $subusers_count
 * @property \river\Models\ServerTransfer|null $transfer
 * @property \river\Models\User $user
 * @property \Illuminate\Database\Eloquent\Collection|\river\Models\EggVariable[] $variables
...
class Server extends Model
{
    ...
    public function variables()
    {
        return $this->hasMany(EggVariable::class, 'egg_id', 'egg_id')
            ...
            ->leftJoin('server_variables', function (JoinClause $join) {
                ...
                //
                // @see https://github.com/river/panel/issues/2250
     ...
     *
     * @throws \river\Exceptions\Http\Server\ServerStateConflictException
     */
