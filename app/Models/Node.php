 ...
 * @property \river\Models\Location $location
 * @property \river\Models\Mount[]|\Illuminate\Database\Eloquent\Collection $mounts
 * @property \river\Models\Server[]|\Illuminate\Database\Eloquent\Collection $servers
 * @property \river\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations
 */
class Node extends Model
{
    ...
    protected $attributes = [
        ...
        'disk_overallocate' => 0,
        'daemonBase' => '/var/lib/river/volumes',
        'daemonSFTP' => 2022,
        'daemonListen' => 8080,
