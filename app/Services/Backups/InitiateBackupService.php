...
namespace river\Services\Backups;
...
use river\Repositories\Eloquent\BackupRepository;
use river\Repositories\Wings\DaemonBackupRepository;
use river\Exceptions\Service\Backup\TooManyBackupsException;
...
class InitiateBackupService
{
    ...
    /**
     * @var \river\Repositories\Eloquent\BackupRepository
     */
    private $repository;
    ...
    /**
     * @var \river\Repositories\Wings\DaemonBackupRepository
     */
    private $daemonBackupRepository;

    /**
     * @var \river\Extensions\Backups\BackupManager
     */
    private $backupManager;

    /**
     * @var \river\Services\Backups\DeleteBackupService
     */
     ...
     *
     * @param \river\Services\Backups\DeleteBackupService $deleteBackupService
     */
     ...
     *
     * @throws \Throwable
     * @throws \river\Exceptions\Service\Backup\TooManyBackupsException
    ...
    public function handle(Server $server, string $name = null, bool $override = false): Backup
    {
        ...
        if (!$server->backup_limit || $successful->count() >= $server->backup_limit) {
            ...
            /** @var \river\Models\Backup $oldest */
