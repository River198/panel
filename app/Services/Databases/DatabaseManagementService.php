...
use river\Extensions\DynamicDatabaseConnection;
use river\Repositories\Eloquent\DatabaseRepository;
use river\Exceptions\Repository\DuplicateDatabaseNameException;
use river\Exceptions\Service\Database\TooManyDatabasesException;
use river\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \river\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    /**
     * @var \river\Extensions\DynamicDatabaseConnection
     */
    private $dynamic;
    ...
    {
        if (!config('river.client_features.databases.enabled')) {
     ...
     *
     * @throws \river\Exceptions\Repository\DuplicateDatabaseNameException
     * @throws \Throwable
     */
