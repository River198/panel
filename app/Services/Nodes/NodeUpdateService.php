...
use river\Exceptions\Service\Node\ConfigurationNotPersistedException;
    ...
    public function handle(Node $node, array $data, bool $resetToken = false)
    {
        ...
        [$updated, $exception] = $this->connection->transaction(function () use ($data, $node) {
            ...
            try {
                ...
                //
                // @see https://github.com/river/panel/issues/1931
                ...
                //
                // @see https://github.com/river/panel/issues/2712
                return [$updated, true];
            }
