...
use river\Models\Objects\DeploymentObject;
...
use river\Services\Deployment\AllocationSelectionService;
use river\Exceptions\Http\Connection\DaemonConnectionException;

class ServerCreationService
{
    /**
     * @var \river\Services\Deployment\AllocationSelectionService
     */
    ...
    /**
     * @var \river\Repositories\Eloquent\EggRepository
     */
     ...
     *
     * @param \river\Services\Servers\ServerConfigurationStructureService $configurationStructureService
     * @param \river\Services\Servers\ServerDeletionService $serverDeletionService
     * @param \river\Services\Servers\VariableValidatorService $validatorService
     */
