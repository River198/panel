...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for river.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="river:guzzle:connect_timeout" value="{{ old('river:guzzle:connect_timeout', config('river.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="river:guzzle:timeout" value="{{ old('river:guzzle:timeout', config('river.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="river:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('river:client_features:allocations:enabled', config('river.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="river:client_features:allocations:range_start" value="{{ old('river:client_features:allocations:range_start', config('river.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="river:client_features:allocations:range_end" value="{{ old('river:client_features:allocations:range_end', config('river.client_features.allocations.range_end')) }}">
