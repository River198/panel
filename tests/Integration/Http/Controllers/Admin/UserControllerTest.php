...
namespace river\Tests\Integration\Http\Controllers\Admin;
...
use river\Http\Controllers\Admin\UserController;
...
class UserControllerTest extends IntegrationTestCase
{
     ...
     * are a subuser of.
     *
     * @see https://github.com/river/panel/issues/2469
     */
    public function testIndexReturnsExpectedData()
    {
        ...
        /** @var \river\Http\Controllers\Admin\UserController $controller */
        ...
        /** @var \river\Models\User[] $response */
