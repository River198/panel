...
namespace river\Tests\Integration\Api\Application;
...
use river\Tests\Traits\Http\IntegrationJsonRequestAssertions;
...
abstract class ApplicationApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this
            ->withHeader('Accept', 'application/vnd.river.v1+json')
