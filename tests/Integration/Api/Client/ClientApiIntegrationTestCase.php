...
namespace river\Tests\Integration\Api\Client;
...
use river\Tests\Integration\TestResponse;
...
abstract class ClientApiIntegrationTestCase extends IntegrationTestCase
{
     ...
     *
     * @param \river\Models\Model|\Illuminate\Database\Eloquent\Model $model
     */
    protected function assertJsonTransformedWith(array $data, $model)
    {
        $reflect = new ReflectionClass($model);
        $transformer = sprintf('\\river\\Transformers\\Api\\Client\\%sTransformer', $reflect->getShortName());
