...
namespace river\Tests\Integration\Services\Servers;
...
class ServerCreationServiceTest extends IntegrationTestCase
{
    ...
    {
        /** @var \river\Models\User $user */
        $user = User::factory()->create();

        /** @var \river\Models\Location $location */
        $location = Location::factory()->create();

        /** @var \river\Models\Node $node */
        $node = Node::factory()->create([
            'location_id' => $location->id,
        ]);

        /** @var \river\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations */
    ...
    /**
     * @return \river\Services\Servers\ServerCreationService
     */
