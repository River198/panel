...
namespace river\Tests\Integration\Services\Deployment;
...
use river\Exceptions\Service\Deployment\NoViableNodeException;
...
class FindViableNodesServiceTest extends IntegrationTestCase
{
     ...
     *
     * @see https://github.com/river/panel/issues/2529
     */
    ...
    {
        /** @var \river\Models\Location[] $locations */
        $locations = Location::factory()->times(2)->create();

        /** @var \river\Models\Node[] $nodes */
        $nodes = [
    ...
    /**
     * @return \river\Services\Deployment\FindViableNodesService
     */
