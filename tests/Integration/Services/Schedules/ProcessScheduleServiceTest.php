...
namespace river\Tests\Integration\Services\Schedules;
...
use river\Jobs\Schedule\RunTaskJob;
...
class ProcessScheduleServiceTest extends IntegrationTestCase
{
    ...
    public function testErrorDuringScheduleDataUpdateDoesNotPersistChanges()
    {
        ...
        /** @var \river\Models\Schedule $schedule */
     ...
     *
     * @see https://github.com/river/panel/issues/2534
     */
     ...
     *
     * @see https://github.com/river/panel/issues/2550
     */
    ...
    /**
     * @return \river\Services\Schedules\ProcessScheduleService
     */
