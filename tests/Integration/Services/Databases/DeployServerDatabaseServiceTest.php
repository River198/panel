...
namespace river\Tests\Integration\Services\Databases;
...
class DeployServerDatabaseServiceTest extends IntegrationTestCase
{
    ...
    {
        config()->set('river.client_features.databases.allow_random', true);
    ...
    public function testErrorIsThrownIfNoDatabaseHostsExistOnNode()
    {
        ...
        config()->set('river.client_features.databases.allow_random', false);
    ...
    /**
     * @return \river\Services\Databases\DeployServerDatabaseService
     */
