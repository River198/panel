...
class DatabaseManagementServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('river.client_features.databases.enabled', true);
    ...
    {
        config()->set('river.client_features.databases.enabled', false);
    ...
    /**
     * @return \river\Services\Databases\DatabaseManagementService
     */
