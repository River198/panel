...
namespace river\Tests\Traits\Integration;
...
trait CreatesTestModels
{
     ...
     *
     * @return array{\river\Models\User, \river\Models\Server}
     */
    ...
    {
        return Egg::query()->where('author', 'support@river.io')->where('name', 'Bungeecord')->firstOrFail();
    }
}
