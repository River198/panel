...
return [
    ...
    */
    ...
    | standard river shipped services.
    */
    'service' => [
    ...
    */
    'tasks' => [
        'clear_log' => env('river_CLEAR_TASKLOG', 720),
        'delete_server' => env('river_DELETE_MINUTES', 10),
    ],
    ...
    */
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://cdn.river.io/releases/latest.json',
    ],
    ...
    */
    'client_features' => [
        'databases' => [
            'enabled' => env('river_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('river_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('river_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('river_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('river_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('river_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    'files' => [
        'max_edit_size' => env('river_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'default_api_version' => 'application/vnd.river.v1+json',
    ...
    */
    'assets' => [
        'use_hash' => env('river_USE_ASSET_HASH', false),
    ],
    ...
    */
    'email' => [
        ...
        'send_install_notification' => env('river_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('river_SEND_REINSTALL_NOTIFICATION', true),
    ],
];
